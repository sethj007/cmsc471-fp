...
const location_country = {'Wisconsin': 'United States', 'Pennsylvania': 'United States', 'Alaska': 'United States', 'Michigan': 'United States', 'Texas': 'United States', 'Washington': 'United States', 'Wyoming': 'United States', 'NewYork': 'Japan', 'Minnesota': 'United States', 'Hawaii': 'United States', 'Nevada': 'United States', 'Ohio': 'United States', 'Montana': 'United States', 'Arizona': 'United States', 'Delaware': 'United States', 'Florida': 'United States', 'Iowa': 'United States', 'Idaho': 'United States', 'Kansas': 'United States', 'Maryland': 'United States', 'Nebraska': 'United States', 'Virginia': 'United States', 'California': 'United States', 'Utah': 'United States', 'Indiana': 'United States', 'Vermont': 'United States', 'Oregon': 'United States', 'Maine': 'United States', 'Massachusetts': 'United States', 'Kentucky': 'United States', 'Oklahoma': 'United States', 'Colorado': 'United States', 'Mississippi': 'United States', 'PuertoRico': 'Italy', 'Guam': 'United States', 'Bermuda': 'Bermuda', 'Ontario': 'Canada', 'Georgia': 'United States', 'Peru': 'Peru', 'Valparaiso': 'United States', 'Santiago': 'Costa Rica', 'Uruguay': 'Uruguay', 'Ecuador': 'Ecuador', 'Colombia': 'Colombia', 'Suriname': 'Suriname', 'Valdivia': 'Chile', 'Talca': 'Chile', 'Argentina': 'Argentina', 'Paraguay': 'Paraguay', 'Tocantins': 'Brazil', 'Bolivia': 'Bolivia, Plurinational State of', 'Trinidad': 'Trinidad and Tobago', 'Guyane': 'France', 'Venezuela': 'Venezuela, Bolivarian Republic of', 'Para': 'Brazil', 'Brazil': 'Brazil', 'SantaCatarina': 'Guatemala', 'PuertoMontt': 'Colombia', 'VinaDelMar': 'Spain', 'Parana': 'Brazil', 'Paraiba': 'Brazil', 'Tucuman': 'Argentina', 'Roraima': 'Brazil', 'Pernambuco': 'Brazil', 'Goias': 'Brazil', 'Temuco': 'Chile', 'Concepcion': 'Chile', 'Rancagua': 'Chile', 'Arica': 'Chile', 'Chile': 'Chile', 'Guyana': 'Guyana', 'Guatemala': 'Guatemala', 'Honduras': 'Honduras', 'Martinique': 'France', 'Vina': 'United States', 'Netherlands': 'Netherlands', 'Norway': 'Norway', 'Switzerland': 'Switzerland', 'Finland': 'Finland', 'Austria': 'Austria', 'Ukraine': 'Ukraine', 'Iceland': 'Iceland', 'Ireland': 'Ireland', 'Bulgaria': 'Bulgaria', 'Estonia': 'Estonia', 'Romania': 'Romania', 'Stockholm': 'Sweden', 'England': 'United Kingdom', 'Denmark': 'Denmark', 'Slovenia': 'Slovenia', 'Luxembourg': 'Luxembourg', 'Sweden': 'Sweden', 'Belgium': 'Belgium', 'Serbia': 'Serbia', 'Spain': 'Spain', 'Greece': 'Greece', 'Albania': 'Albania', 'Croatia': 'Croatia', 'Hungary': 'Hungary', 'Moldova': 'Moldova, Republic of', 'Latvia': 'Latvia', 'Macedonia': 'United States', 'Lithuania': 'Lithuania', 'Poland': 'Poland', 'Portugal': 'Portugal', 'France': 'France', 'Lisbon': 'Portugal', 'Bretagne': 'France', 'Toulon': 'France', 'Madrid': 'Spain', 'Catalonia': 'Spain', 'Scotland': 'United Kingdom', 'Thuringen': 'Germany', 'Wrexham': 'United Kingdom', 'Montenegro': 'Montenegro', 'Kosovo': 'XKX', 'Slovakia': 'Slovakia', 'Poprad': 'Slovakia', 'Sturovo': 'Slovakia', 'Trnava': 'Slovakia', 'Iasi': 'Romania', 'Constanta': 'Romania', 'Maramures': 'Romania', 'Romania_SV': 'Romania', 'Vologda': 'Russian Federation', 'Moscow': 'Russian Federation', 'Yekaterinburg': 'Russian Federation', 'Vladivostok': 'Russian Federation', 'Stavropol': 'Russian Federation', 'Kyiv': 'Ukraine', 'Tyumen': 'Russian Federation', 'Voronezh': 'Russian Federation', 'Vladimir': 'Russian Federation', 'Yakutia': 'Russian Federation', 'Tula': 'France', 'Khakassia': 'Russian Federation', 'Orenburg': 'Russian Federation', 'Ordu': 'Türkiye', 'Zonguldak': 'Türkiye', 'Germany': 'Germany', 'Hessen': 'Germany', 'Bremen': 'Germany', 'Sachsen': 'Germany', 'Rome': 'Italy', 'Parma': 'Italy', 'Palermo': 'Italy', 'Trieste': 'Italy', 'Ancona': 'Italy', 'Veneto': 'Italy', 'Pordenone': 'Italy', 'Trapani': 'Italy', 'Paris': 'France', 'Lyon': 'France', 'Grenoble': 'France', 'Rennes': 'France', 'Moulins': 'France', 'Picardie': 'France', 'Glasgow': 'United Kingdom', 'Swansea': 'United Kingdom', 'Tenby': 'United Kingdom', 'Ystrad': 'United Kingdom', 'Mold': 'United Kingdom', 'Ystad': 'Sweden', 'Visby': 'Sweden', 'Vaxjo': 'Sweden', 'Trollhattan': 'Sweden', 'Vasteras': 'Sweden', 'Uppsala': 'Sweden', 'Murcia': 'Spain', 'Navarra': 'Spain', 'Zamora': 'Spain', 'Valencia': 'Spain', 'LaRioja': 'Ecuador', 'Leon': 'United States', 'Galicia': 'Spain', 'Valladolid': 'Spain', 'Athens': 'United States', 'Heraklion': 'Egypt', 'Malta': 'Malta', 'Yokohama': 'Japan', 'Vietnam': 'Viet Nam', 'HongKong': 'China', 'SriLanka': 'Sri Lanka', 'Bangladesh': 'Bangladesh', 'Singapore': 'Singapore', 'Maldives': 'Maldives', 'Tokyo': 'Japan', 'India': 'India', 'Bhutan': 'Bhutan', 'Lao': "Lao People's Democratic Republic", 'Thailand': 'Thailand', 'Taiwan': 'Taiwan, Province of China', 'Nepal': 'Nepal', 'Philippines': 'Philippines', 'Bahrain': 'Bahrain', 'Zhejiang-Shangcheng': 'China', 'Zhejiang-Nanhu': 'China', 'SuratThani': 'Thailand', 'Yamaguchi': 'Japan', 'Cambodia': 'Cambodia', 'Kanagawa': 'Japan', 'Yunnan-Wenshan': 'China', 'Yokosuka': 'Japan', 'Saitama': 'Japan', 'Nonthaburi': 'Thailand', 'Shanghai': 'China', 'Wuhan': 'China', 'Seoul': 'Korea, Republic of', 'Pakistan': 'Pakistan', 'Afghanistan': 'Afghanistan', 'SaudiArabia': 'Türkiye', 'AbuDhabi': 'United Arab Emirates', 'Abudhabi': 'United Arab Emirates', 'Oman': 'Oman', 'Lebanon': 'Lebanon', 'Ulaanbaatar': 'Mongolia', 'Kazakhstan': 'Kazakhstan', 'Choibalsan': 'Mongolia', 'Zamyn-Uud': 'Mongolia', 'Uvs': 'Mongolia', 'Zavkhan': 'Mongolia', 'Brunei': 'Brunei Darussalam', 'Indonesia': 'Indonesia', 'Myanmar': 'Myanmar', 'Yangon': 'Myanmar', 'Phuket': 'Thailand', 'Yasothon': 'Thailand', 'Trang': 'Thailand', 'Lopburi': 'Thailand', 'Chanthaburi': 'Thailand', 'Loei': 'Belgium', 'Ranong': 'Thailand', 'ChonBuri': 'Thailand', 'Mahasarakham': 'Thailand', 'Nakhonphanom': 'Thailand', 'ChiangRai': 'Thailand', 'Tehran': 'Iran, Islamic Republic of', 'Varamin': 'Iran, Islamic Republic of', 'Kuwait': 'Kuwait', 'Qatar': 'Qatar', 'SouthKorea': 'Korea, Republic of', 'Ulsan': 'Korea, Republic of', 'Kobe': 'Japan', 'Beijing': 'China', 'Tianjin-Hexi': 'China', 'Tianjin-Nankai': 'China', 'Sichuan-Gaoxin': 'China', 'Sichuan-Qingyang': 'China', 'Sichuan-Ziliujing': 'China', 'Sichuan-Jinjiang': 'China', 'Yunnan-Linxiang': 'China', 'Yunnan-Xianggelila': 'China', 'Yunnan-Zhaoyang': 'China', 'Yunnan-Zhenxiong': 'China', 'Yunnan-Chuxiong': 'China', 'Yunnan-Gucheng': 'China', 'Yunnan-Qilin': 'China', 'Yunnan-Xishan': 'China', 'Zhejiang-Haishu': 'China', 'Zhejiang-Nanxun': 'China', 'Zhejiang-Yongkang': 'China', 'Zhejiang-yongkang': 'China', 'Zhejiang-NH': 'China', 'Zhejiang-Tongxiang': 'China', 'Zhejiang-Yiwu': 'China', 'Zhejiang-Xihu': 'China', 'Zhejiang-Jiaojiang': 'China', 'Zhejiang-Xiuzhou': 'China', 'Zhejiang-Lucheng': 'China', 'Jiangxi-Donghu': 'China', 'Jiangxi-Zhushan': 'China', 'Jilin-Ningjiang': 'China', 'Guangxi': 'China', 'Guangxi-Fangcheng': 'China', 'Guangxi-Longzhou': 'China', 'Guangdong-Zhongshan': 'China', 'Guangdong-Zhenjiang': 'China', 'Hunan-yanfeng': 'China', 'Henan-Shihe': 'China', 'Fujian-Xinluo': 'China', 'Fujian-Pinghe': 'China', 'Fujian-Yanping': 'China', 'Anhui-Jinan': 'China', 'Guizhou-Nanming': 'China', 'Shaanxi-Hanbin': 'China', 'Xinjiang-Changji': 'China', 'Qinghai-Tongren': 'China', 'Beijing-Huairou': 'China', 'Beijing-Chaoyang': 'China', 'Shanghai-Putuo': 'China', 'Shanghai-Fengxian': 'China', 'Sapporo': 'Japan', 'Sendai': 'Japan', 'Sendai-H': 'Japan', 'Yamagata': 'Japan', 'Yamanashi': 'Japan', 'Wakayama': 'Japan', 'Wakayama-C': 'Japan', 'Shizuoka': 'Japan', 'Shizuoka-C': 'Japan', 'Miyazaki': 'Japan', 'Miyagi': 'Japan', 'Nagano': 'Japan', 'Okinawa': 'Japan', 'Kitakyushu': 'Japan', 'Kawasaki': 'Japan', 'Toyama': 'Japan', 'Tochigi': 'Japan', 'Odisha': 'India', 'Anantnag': 'India', 'Sidon': 'United States', 'Zahle': 'Lebanon', 'Zgharta': 'Lebanon', 'Muscat': 'Oman', 'Salalah': 'Oman', 'Sharjah': 'United Arab Emirates', 'Fujairah': 'United Arab Emirates', 'Uaq': 'Argentina', 'Turkmenistan': 'Turkmenistan', 'Zhetysu': 'Kazakhstan', 'SouthAfrica': 'South Africa', 'Zambia': 'Zambia', 'Togo': 'Togo', 'Kenya': 'Kenya', 'Ghana': 'Ghana', 'Niger': 'Niger', 'Mali': 'Mali', 'Uganda': 'Uganda', 'Mozambique': 'Mozambique', 'Tunisia': 'Tunisia', 'BurkinaFaso': 'Burkina Faso', 'Congo': 'Congo, The Democratic Republic of the', 'Cameroon': 'Cameroon', 'Nigeria': 'Nigeria', 'Ethiopia': 'Ethiopia', 'Tanzania': 'Tanzania, United Republic of', 'Madagascar': 'Madagascar', 'Antananarivo': 'Madagascar', 'Tsaralalana': 'Madagascar', 'Tanger': 'Morocco', 'Yaounde': 'Cameroon', 'Johannesburg': 'South Africa', 'Southafrica': 'South Africa', 'South-Africa': 'South Africa', 'Mayotte': 'France', 'Reunion': 'France', 'Victoria': 'Australia', 'Wellington': 'New Zealand', 'Sydney': 'Australia', 'Darwin': 'Australia', 'Brisbane': 'Australia', 'Perth': 'Australia', 'Tasmania': 'Australia', 'Townsville': 'Australia', 'Canberra': 'Australia', 'Newcastle': 'United Kingdom', 'Christchurch': 'New Zealand', 'Waikato': 'New Zealand', 'Wairarapa': 'New Zealand', 'Canterbury': 'United Kingdom', 'Fiji': 'Fiji', 'Papeete': 'France', 'Samoa': 'Samoa', 'NorthCarolina': 'United States', 'NewJersey': 'United States', 'NewMexico': 'United States', 'SouthDakota': 'United States', 'NorthDakota': 'United States', 'SouthCarolina': 'United States', 'RhodeIsland': 'United States', 'DistrictOfColumbia': 'United States', 'SaoPaulo': 'Brazil', 'Saopaulo': 'Brazil', 'MinasGerais': 'Brazil', 'RioGrandedoNorte': 'Brazil', 'RioGrandeDoNorte': 'Brazil', 'RioGrandedoSul': 'Brazil', 'AltoHospicio': 'Chile', 'StPetersburg': 'Russia', 'YoshkarOla': 'Russia', 'VelikyNovgorod': 'Russia', 'CzechRepublic': 'Czech Republic', 'FrancheComte': 'France', 'NorthernIreland': 'United Kingdom', 'UnitedKingdom': 'United Kingdom', 'BosniaHerzegovina': 'Bosnia and Herzegovina', 'BanskaBystrica': 'Slovakia', 'SchleswigHolstein': 'Germany', 'StEtienne': 'France', 'ValencianCommunity': 'Spain', 'Srinigar': 'India', 'TimorLeste': 'Timor-Leste', 'PhraNakhonSiAyutthaya': 'Thailand', 'Yunnan-Mengliandaizulahuzuwazuzizhi': 'China', 'Zhejiang-Wuxin': 'China', 'Zhejiang-TX': 'China', 'Zhejiang-Zhangxing': 'China', 'Hainan-Baotinglizumiaozuzizhi': 'China', 'Guizhou-Yilongxin': 'China', 'WuhanQiaokou': 'China', 'MountLebanon': 'Lebanon', 'RasAlKhaimah': 'United Arab Emirates', 'UmmAlQuwain': 'United Arab Emirates', 'CoteDIvoire': "Côte d'Ivoire", 'NosyBe': 'Madagascar', 'SouthAustralia': 'Australia', 'WesternAustralia': 'Australia', 'NorthernTerritory': 'Australia', 'NewZealand': 'New Zealand', 'SouthAuckland': 'New Zealand', 'Southauckland': 'New Zealand', 'NewCaledonia': 'France', 'SolomonIslands': 'Solomon Islands'}
...
function drawTree(newickData) {
    ...
    node.append("circle")
        ...
        .on("mouseover", function(event, d) {
            ...
            countryName = location_country[location]
            if (countryName && window.highlightMapCountry) {
                console.log(countryName)
            window.highlightMapCountry(countryName);
        }
        })
